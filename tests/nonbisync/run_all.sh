...
TMP_ROOT="${TMPDIR:-/tmp}/redisgunyu-nonbisync-all"
...
write_report() {
  {
    echo "# Non-Bisync All Tests Report"
    echo
...
run_case category1 bash ./tests/nonbisync/run_category1.sh
run_case category2 bash ./tests/nonbisync/run_category2.sh
run_case category3 bash ./tests/nonbisync/run_category3.sh
run_case category4 bash ./tests/nonbisync/run_category4.sh
run_case category5 bash ./tests/nonbisync/run_category5.sh
run_case category6 bash ./tests/nonbisync/run_category6.sh
run_case category7 bash ./tests/nonbisync/run_category7.sh
